...
// let qtdeXP = prompt("Quanto você tem de experiência, herói?");
// while(nome == "" || nome == null){
//     qtdeXP = prompt("Por favor, me informe quanto você tem de experiência, herói?");
// }
...
// if(classificacao != ""){
//     console.log(`O Herói de nome ${nome} está no nível de ${classificao}.`);
// }